...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  <div class="container-fluid">
    <ul class="navbar-nav">
	  ...
	  <li class="nav-item">
        <a class="nav-link active" href="televizio.php">Televízió</a>
      </li>
      <li class="nav-item">
...
$sql = "SELECT * FROM termek WHERE kategoria = 'televizio'";
...
if (mysqli_num_rows($result) > 0) {
  ...
  while($row = mysqli_fetch_assoc($result)) {
    ...
    print("<td><img src=\"fotok/$row[termek_kepe_nagy]\" alt=\"Hiányzik a kép!\"
